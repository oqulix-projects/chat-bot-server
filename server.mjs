...
ഭാഷ മലയാളമായിരിക്കണം. പ്രോഡക്ട് വിവരങ്ങൾ നൽകുക. Do not use emojis, do not use ":" or unwanted punctuations because google tts cant read it`
...
Respond only in English. Do not use emojis, do not use ":" or unwanted punctuations because google tts cant read it`;
